...
Maze.Grid = (function () {
    function a(d, c) {
        ...
        this.data = (function () {
            var h, g, f;
            f = [];
            for (e = h = 1, g = this.height; 1 <= g ? h <= g : h >= g; e = 1 <= g ? ++h : --h) {
                f.push((function () {
                    var k, i, j;
                    j = [];
                    for (b = k = 1, i = this.width; 1 <= i ? k <= i : k >= i; b = 1 <= i ? ++k : --k) {
                        j.push(0)
                    }
                    return j
                }).call(this))
...
Maze.createWidget = function (i, c, m, o) {
    ...
    if ((e = o.watch) != null ? e : true) {
        h = "<a id='" + b + "_watch' href='#' onclick='document.getElementById(\"" + b + "\").mazeQuickStep(); return false;'>Watch</a>"
    } else {
        h = ""
    }
    ...
    f.mazeReset = function () {
        ...
        this.maze.onEvent(n);
        p = "";
        for (z = v = 0, t = this.maze.height; 0 <= t ? v < t : v > t; z = 0 <= t ? ++v : --v) {
            q = "" + this.id + "_y" + z;
            p += "<div class='row' id='" + q + "'>";
            for (A = u = 0, s = this.maze.width; 0 <= s ? u < s : u > s; A = 0 <= s ? ++u : --u) {
                p += "<div id='" + q + "x" + A + "'>";
                if (o.padded) {
                    p += "<div class='np'></div>";
                    p += "<div class='wp'></div>";
...
Maze.createCanvasWidget = function (s, q, m, d) {
    ...
    if ((b = d.watch) != null ? b : true) {
        k = "<a id='" + o + "_watch' href='#' onclick='document.getElementById(\"" + o + "\").mazeQuickStep(); return false;'>Watch</a>"
    } else {
        k = ""
    }
...
Maze.Algorithms.Eller = (function (a) {
    ...
    b.prototype.verticalStep = function () {
        ...
        if (this.verticals.length === 0) {
            ...
            d = [this.column, this.verticals.pop()], c = d[0], this.column = d[1];
        ...
        if (this.remaining > 0) {
            ...
            for (e = 0, k = g.length; e < k; e++) {
                ...
                if (this.maze.isValid(i, h)) {
                    d = [this.x, this.y, i, h], l = d[0], j = d[1], this.x = d[2], this.y = d[3];
                    if (this.maze.isBlank(i, h)) {
                        this.maze.carve(l, j, c);
                        this.maze.carve(this.x, this.y, Maze.Direction.opposite[c]);
                        this.remaining--;
                        f = true;
                        if (this.remaining === 0) {
                            delete this.x;
...
Maze.Algorithms.RecursiveBacktracker = (function (b) {
    ...
    a.prototype.startStep = function () {
        var c, e, d;
        d = [this.rand.nextInteger(this.maze.width), this.rand.nextInteger(this.maze.height)], c = d[0], e = d[1];
        ...
        while (true) {
            ...
            if (this.maze.isValid(c, f)) {
                if (this.maze.isBlank(c, f)) {
                    ...
                    this.maze.carve(c, f, Maze.Direction.opposite[d] | this.STACK);
                    this.updateAt(c, f);
...
var BlobbyCell, BlobbyRegion, __hasProp = {}.hasOwnProperty,
    __extends = function (d, b) {
        for (var a in b) {
            if (__hasProp.call(b, a)) {
                d[a] = b[a]
...
Maze.Algorithms.BlobbyDivision = (function (b) {
    ...
    a.prototype.plantSeeds = function () {
        ...
        f = this.rand.randomizeList((function () {
            d = [];
            for (var j = 0, i = this.region.cells.length; 0 <= i ? j < i : j > i; 0 <= i ? j++ : j--) {
                d.push(j)
            }
            return d
        }).apply(this));
    ...
    a.prototype.drawWall = function () {
        ...
        while (this.boundary.length > 0 && d < this.wallSpeed) {
            ...
            this.maze.uncarve(m.to.col, m.to.row, Maze.Direction.opposite[m.dir]);
...
Maze.Algorithms.RecursiveDivision = (function (b) {
    ...
    a.prototype.isCurrent = function (c, d) {
        return (this.region != null) && (this.region.x <= c && c < this.region.x + this.region.width) && (this.region.y <= d && d < this.region.y + this.region.height)
    };
    ...
    a.prototype.updateRegion = function (g) {
        var c, h, f, e, d;
        d = [];
        for (h = f = 0, e = g.height; 0 <= e ? f < e : f > e; h = 0 <= e ? ++f : --f) {
            d.push((function () {
                var k, i, j;
                j = [];
                for (c = k = 0, i = g.width; 0 <= i ? k < i : k > i; c = 0 <= i ? ++k : --k) {
    ...
    a.prototype.makePassage = function () {
        var e, d, j, g, f, h, c, i;
        g = this.wx + (this.horizontal ? this.rand.nextInteger(this.region.width) : 0);
        f = this.wy + (this.horizontal ? 0 : this.rand.nextInteger(this.region.height));
        ...
        h = this.horizontal ? this.region.width : this.region.x + this.region.width - this.wx - 1;
        e = this.horizontal ? this.region.y + this.region.height - this.wy - 1 : this.region.height;
        if (h >= 2 && e >= 2) {
            this.stack.push({
                x: c,
                y: i,
...
Maze.Algorithms.Sidewinder = (function (b) {
    ...
    a.prototype.step = function () {
        ...
        if (this.y > 0 && (this.x + 1 >= this.maze.width || this.rand.nextBoolean())) {
            c = this.runStart + this.rand.nextInteger(this.x - this.runStart + 1);
...
Maze.Algorithms.GrowingTree = (function (b) {
    ...
    function a(e, c) {
        ...
        this.cells = [];
        this.state = 0;
        this.script = new Maze.Algorithms.GrowingTree.Script((d = c.input) != null ? d : "random", this.rand)
    }
...
Maze.Algorithms.HuntAndKill = (function (b) {
    ...
    a.prototype.callbackRow = function (g) {
        var c, f, e, d;
        d = [];
        for (c = f = 0, e = this.maze.width; 0 <= e ? f < e : f > e; c = 0 <= e ? ++f : --f) {
        ...
        for (e = 0, k = f.length; e < k; e++) {
            ...
            if (this.maze.isValid(h, g)) {
                if (this.maze.isBlank(h, g)) {
                    d = [this.x, this.y, h, g], l = d[0], i = d[1], this.x = d[2], this.y = d[3];
                    ...
                    if (this.canWeave(j, h, g)) {
                        this.performWeave(j, this.x, this.y, (function (m) {
                            return function (n, p) {
                                var o;
                                return o = [m.x, m.y, n, p], n = o[0], p = o[1], m.x = o[2], m.y = o[3], o
                            }
                        })(this));
                        return
                    }
    ...
    a.prototype.huntStep = function () {
        var h, e, d, i, c, g, f;
        for (c = g = 0, f = this.maze.width; 0 <= f ? g < f : g > f; c = 0 <= f ? ++g : --g) {
            if (this.maze.isBlank(c, this.y)) {
                ...
                if (this.y + 1 < this.maze.height && !this.maze.isBlank(c, this.y + 1)) {
                    e.push(Maze.Direction.S)
                }
                if (c + 1 < this.maze.width && !this.maze.isBlank(c + 1, this.y)) {
...
Maze.Algorithms.Kruskal = (function (b) {
    ...
    function a(k, l) {
        ...
        this.sets = [];
        this.edges = [];
        for (i = g = 0, h = this.maze.height; 0 <= h ? g < h : g > h; i = 0 <= h ? ++g : --g) {
            this.sets.push([]);
            for (j = e = 0, f = this.maze.width; 0 <= f ? e < f : e > f; j = 0 <= f ? ++e : --e) {
    ...
    a.prototype.weaveStep = function () {
        ...
        while (this.state === this.WEAVE) {
            if (this.maze.isBlank(this.x, this.y) && this.rand.nextInteger(100) < this.weaveDensity) {
                ...
                j = !this.sets[p][q].isConnectedTo(this.sets[l][m]) && !this.sets[t][u].isConnectedTo(this.sets[n][o]);
                if (j) {
                    ...
                    for (e = 0, r = c.length; e < r; e++) {
                        i = c[e];
                        if ((i.x === this.x && i.y === this.y) || (i.x === o && i.y === n && i.direction === Maze.Direction.W) || (i.x === m && i.y === l && i.direction === Maze.Direction.N)) {
                            continue
                        }
                        s.push(i)
                    }
    ...
    a.prototype.joinStep = function () {
        ...
        while (this.edges.length > 0) {
            ...
            k = this.sets[c.y][c.x];
            i = this.sets[j][l];
            if ((this.maze.isWeave != null) && this.weaveMode === "onePhase" && this.maze.isPerpendicular(l, j, c.direction)) {
                o = l + Maze.Direction.dx[c.direction];
                n = j + Maze.Direction.dy[c.direction];
                g = null;
                for (m = f = 0, h = this.edges.length; 0 <= h ? f < h : f > h; m = 0 <= h ? ++f : --f) {
                    d = this.edges[m];
...
Maze.Algorithms.Wilson = (function (b) {
    ...
    a.prototype.runStep = function () {
        ...
        if (this.remaining > 0) {
            ...
            f = [this.x, this.y, d, h], c = f[0], g = f[1], this.x = f[2], this.y = f[3];
            if (this.state === 1) {
                delete this.x;
                delete this.y
            }
